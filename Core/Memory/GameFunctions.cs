namespace Spotlight.Core.Memory
{
    ...
    {
        public delegate long DrawCoronaDelegate(CCoronaDrawQueue* drawQueue, NativeVector3* position, float coronaSize, uint colorBGRA, float coronaIntensity, float unk_100, NativeVector3* direction, float unk_1, float innerAngle, float outerAngle, ushort unk_3);
